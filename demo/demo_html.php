...
<body>
    <ol>
        ...
        echo '<li>Next create a QR code and let the user scan it:<br>' . $tfa->getQRCodeHTML('My label', $secret) . '<br>...or display the secret to the user for manual entry: ' . chunk_split($secret, 4, ' ');
